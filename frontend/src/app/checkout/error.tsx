  ...
  return (
    <main className="max-w-screen-lg container mx-auto px-4 py-[25px] my-[25px] sm:pt-[65px] sm:mb-[120px]">
      <div className="flex flex-col items-center justify-center">
        <svg
          className="w-1/2 md:w-1/3 lg:w-1/4 text-primary"
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-foreground mt-8">
            500
          </p>
          <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mt-2">
            Error de servidor
          </p>
          <p className="md:text-lg xl:text-xl text-gray-500 mt-4">
            Whoops, algo salió mal en nuestros servidores.
          </p>
