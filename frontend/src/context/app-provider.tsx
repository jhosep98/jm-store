  ...
  return (
    <CartStoreProvider>
      ...
      <Toaster
        ...
        //   ),
        //   error: (
        //     <div className="flex-none relative w-9 h-9 rounded-full bg-danger-50 dark:bg-danger-100 border-danger-100 shadow-small border-1">
        //       <svg
        //         fill="none"
        //         height="20"
        //         viewBox="0 0 20 20"
        ...
        //   ),
        //   info: (
        //     <div className="flex-none relative w-9 h-9 rounded-full bg-primary-50 dark:bg-primary-100 border-primary-100 shadow-small border-1">
        //       <svg
        //         fill="none"
        //         height="24"
        //         viewBox="0 0 24 24"
        ...
        //   ),
        //   warning: (
        //     <div className="flex-none relative w-9 h-9 rounded-full bg-warning-50 dark:bg-warning-100 border-warning-100 shadow-small border-1">
        //       <svg
        //         fill="none"
        //         height="24"
        //         viewBox="0 0 24 24"
